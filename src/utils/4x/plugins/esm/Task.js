...
var Task = /** @class */ (function (_super) {
    ...
    function Task(view) {
        ...
        _this.view = null;
        _this.boundarylayerid = "";
        _this.init(view);
        return _this;
    }
    Task.prototype.query = function (boundaryOptions) {
                        ...
                        return [4 /*yield*/, load(["esri/layers/GraphicsLayer", "esri/Graphic"])
                                ...
                                return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0:
                                                if (!boundaryOptions.LayerID) {
                                                    return [2 /*return*/];
                                                }
                                                if (!this.view) {
                                                    return [2 /*return*/];
                                                }
                                                layer = this.view.map.findLayerById(boundaryOptions.LayerID);
                                                if (!layer) {
                                                    return [2 /*return*/];
                                                }
                                                ...
                                                return [4 /*yield*/, layer.queryFeatures(boundaryqueryParams).then(function (response) {
                                                        if (response.features.length > 0) {
                                                            var boundaryLayer_1 = _this.view.map.findLayerById(_this.boundarylayerid);
                                                            if (typeof (boundaryLayer_1) === 'undefined') {
                                                                boundaryLayer_1 = new GraphicsLayer({
                                                                    title: _this.boundarylayerid,
                                                                    id: _this.boundarylayerid,
                                                                    listMode: 'show'
                                                                });
    ...
    Task.prototype.remove = function () {
        var boundaryLayer = this.view.map.findLayerById(this.boundarylayerid);
        if (boundaryLayer) {
            this.view.map.remove(boundaryLayer);
        }
    };
    Task.prototype.init = function (view) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
